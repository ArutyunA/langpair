...
SCENARIO_META = {
    ...
    11: ("After-School Catch-Up", "Parent", "Daughter"),
    12: ("Hurrying to Homeroom", "Friend", "Student"),
    13: ("Cold Evening Texts", "Friend", "Friend"),
    14: ("James at the Company", "Coworker", "Coworker"),
    15: ("Lisa Wants New Shoes", "Shopping Buddy", "Friend"),
    16: ("Andy Shares News", "Friend", "Friend"),
    17: ("Jack Preps for a Party", "Friend", "Friend"),
    18: ("Too Small Apartment", "Roommate", "Roommate"),
    19: ("Ho Yi's Screen Routine", "Friend", "Friend"),
    20: ("Ziyi at the Restaurant", "Dining Partner", "Server"),
    21: ("Music Break with Hiu Suet", "Friend", "Friend"),
    22: ("Workout Accountability", "Workout Buddy", "Friend"),
    23: ("Zi Jun Wants a New Job", "Career Coach", "Job Seeker"),
    24: ("Unwinding After Work", "Friend", "Friend"),
    25: ("Morning Outfit Rush", "Sibling", "Sibling"),
    26: ("School Break Chat", "Classmate", "Classmate"),
    27: ("Mei Mei Heads Back to Work", "Coworker", "Coworker"),
    28: ("One-Day Vacation", "Friend", "Friend"),
    29: ("Checking on Yuet Ling", "Friend", "Friend"),
    30: ("Campus Life with Ah Yan", "Classmate", "Student"),
    31: ("Ka Chung Hunts for Work", "Friend", "Job Seeker"),
    32: ("Waiting for the Baby", "Friend", "Expectant Parent"),
    33: ("Cleaning Ah Wai's Room", "Friend", "Roommate"),
    34: ("Ah Lam Plans a Trip", "Travel Buddy", "Traveler"),
    35: ("Finally Leaving the Country", "Friend", "Traveler"),
    36: ("Learning to Cook", "Coach", "Student"),
    37: ("Early Saturday Routine", "Friend", "Friend"),
    38: ("Friend Moved Far Away", "Friend", "Friend"),
    39: ("Breakfast Experiments", "Friend", "Friend"),
    40: ("Lecture Hall Catch-Up", "Classmate", "Classmate"),
    41: ("Class Dinner Plans", "Classmate", "Classmate"),
    42: ("Never Had a Dog", "Parent", "Child"),
    43: ("Neighbor's Big Family", "Neighbor", "Neighbor"),
    44: ("Pre-Work Jitters", "Friend", "Friend"),
    45: ("Story of Two Friends", "Narrator", "Friend"),
    46: ("Concert Night", "Friend", "Friend"),
    47: ("Crowded Household", "Family Member", "Family Member"),
    48: ("Restaurant Catch-Up", "Friend", "Friend"),
    49: ("Buying a Dog", "Friend", "Friend"),
    50: ("Jason Reviews His Schedule", "Classmate", "Classmate"),
    51: ("Living Alone in a Small Flat", "Friend", "Friend"),
    52: ("Three-Day Hike", "Hiking Buddy", "Hiker"),
    53: ("Flight to Los Angeles", "Friend", "Traveler"),
    54: ("New Job Energy", "Friend", "Friend"),
    55: ("Parents Push for University", "Student", "Parent"),
}
